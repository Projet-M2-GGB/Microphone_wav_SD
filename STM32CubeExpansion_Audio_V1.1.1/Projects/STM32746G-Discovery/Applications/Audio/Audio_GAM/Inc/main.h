...
#define AUDIO_CFG_GAM_VOL_MAX                     GAM_VOL_MAX
#define AUDIO_CFG_GAM_VOL_MIN                     GAM_VOL_MIN
#define AUDIO_CFG_GAM_VOL_DEFAULT                 -12

#define AUDIO_CFG_GAM_CHAN_MAX                    (GAM_NB_CHAN_MAX-1)
#define AUDIO_CFG_GAM_CHAN_MIN                    0 
#define AUDIO_CFG_GAM_CHAN_DEFAULT                0 
...
typedef enum {
  ...
  AUDIO_CFG_GAM_MUTE_EN,
  AUDIO_CFG_GAM_MUTE_DIS,
  AUDIO_CFG_GAM_VOL_PREVIOUS,
  AUDIO_CFG_GAM_VOL_NEXT,
  AUDIO_CFG_GAM_CHAN_PREVIOUS,
  AUDIO_CFG_GAM_CHAN_NEXT,
  AUDIO_CFG_ERROR,  
