...
//center frequency: 10 62, 115, 214, 399, 742, 1380, 2567, 4775, 8882, 16520
//user gains: -12 ; +12dB
//const int16_t PRESET_GAIN_POP_10[] = {  8, 5, -2, -4, -5, -3, 0, 4, 7, 8
//static int16_t UserGaindB[GREQ_NB_BANDS_10] = {-12,12,-12,12,-12,12,-12,12,-12,12};    /* Gain for each band*/
static int16_t UserGaindB[GREQ_NB_BANDS_10] = {-12,-12,-12,-12,12,12,12,12,12,12}; 
