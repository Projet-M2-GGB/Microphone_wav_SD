...
/** @defgroup Decoders_Exported_Defined
* @{
*/
/*-- FOR AUDIO RECORDER --*/
#define MAX_IN_PACKET_SZE                              (uint32_t)(576*2*2)

/*-- FOR AUDIO PLAYER --*/
#define MAX_OUT_DEFAULT_PACKET_SZE                     (uint32_t)(3072*2*2)
#define MAX_AUDIO_DEFAULT_HEADER_SIZE                  200

/*-- FOR AUDIO RECORDERS and PLAYERS --*/
#if defined(__WAV_DECODER__) || defined(__WAV_ENCODER__)
#ifndef WAV_PACKET_SZE
#define WAV_PACKET_SZE                                WAV_PACKET_SZE_PROC  /* 480 stereo samples of 16-bits*/
#endif

#ifndef WAVIN_PACKET_SZE
#define WAVIN_PACKET_SZE                              WAVIN_PACKET_SZE_PROC /* 480 samples stereo 16-bit*/
#endif
#endif /* __WAV_DECODER__ */

#if defined(__MP3_DECODER__) || defined(__MP3_ENCODER__)
#ifndef MP3_PACKET_SZE
#define MP3_PACKET_SZE                                (uint32_t)(1152*2*2) /* Decoder: 1152 stereo samples of 16-bits*/
#endif

#ifndef MP3IN_PACKET_SZE
#define MP3IN_PACKET_SZE                              (uint32_t)(576*2*2) /* Encoder: 576 samples stereo 16-bit*/
#endif
#endif /* __MP3_DECODER__ */
...
#define WMA_PACKET_SZE                                (uint32_t)(3072*2*2) /* Max decoded frame size 3072 = 2048 samples x 1.5 then 3*3072=9216 stereo samples of 16-bits*/
#endif
#endif /* __WMA_DECODER__ */

#if defined(__AAC_DECODER__)
#ifndef AAC_PACKET_SZE
#define AAC_PACKET_SZE                                (uint32_t)(1024*2*2) /* 1024 stereo samples of 16-bits */
#endif
#endif /* __AAC_DECODER__ */
...
#define ADPCM_PACKET_SZE                               (uint32_t)(ADPCM_FRAME_SIZE * 2 * 2) /* ADPCM_FRAME_SIZE stereo samples of 16-bits */
#endif
#endif /* __ADPCM_DECODER__ */

#if defined(__SPEEX_DECODER__) || defined(__SPEEX_ENCODER__)
#ifndef SPEEX_PACKET_SZE
#define SPEEX_PACKET_SZE                                (uint32_t)(RAW_FRAME_SIZE * 2 * 2) /* 160 stereo samples of 16-bits for narrowband                                                                                               320 stereo samples of 16-bits for wideband */
#endif
#endif /* __SPEEX_DECODER__ */
...
#define G711_PACKET_SZE                                (uint32_t)(G711_FRAME_SIZE * 2 * 2) /* G711_FRAME_SIZE stereo samples of 16-bits */
#endif
#endif /* __G711_DECODER__ */

#if defined(__G726_DECODER__) || defined(__G726_ENCODER__)
#ifndef G726_PACKET_SZE
#define G726_PACKET_SZE                                (uint32_t)(G726_FRAME_SIZE * 2 * 2) /* G726_FRAME_SIZE stereo samples of 16-bits */
#endif
#endif /* __G726_DECODER__ */
