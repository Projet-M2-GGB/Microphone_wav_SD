...
#if 0
#define AUDIO_CFG_CDC_VOL_MAX                      24
#define AUDIO_CFG_CDC_VOL_MIN                     -24
#define AUDIO_CFG_CDC_VOL_DEFAULT                  0

#define AUDIO_CFG_CDC_FREQX_MAX                    11 /* 300Hz */
#define AUDIO_CFG_CDC_FREQX_MIN                    0  /* 60Hz  */
#define AUDIO_CFG_CDC_FREQX_DEFAULT                4  /* 120Hz */
#endif
...
typedef enum {
  ...
  //AUDIO_CFG_CDC_EN,
  //AUDIO_CFG_CDC_DIS,
  AUDIO_CFG_CDC_MODE_DOWNS,
  AUDIO_CFG_CDC_MODE_UPS,
  //AUDIO_CFG_CDC_FREQX_PREVIOUS,
  //AUDIO_CFG_CDC_FREQX_NEXT,
  AUDIO_CFG_ERROR,  
