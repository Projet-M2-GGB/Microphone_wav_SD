...
#define BIQ_FILT_PEAK      1
#define BIQ_FILT_LOUDNESS  2
#define BIQ_FILT_NOTCH     3
#define BIQ_FILT_VOICE     4
#define BIQ_FILT_LPASS     5
#define BIQ_FILT_HPASS     6
#define BIQ_FILT_BYPASS    7

#define BIQ_FILT_MIN      BIQ_FILT_PEAK
#define BIQ_FILT_MAX      BIQ_FILT_BYPASS
