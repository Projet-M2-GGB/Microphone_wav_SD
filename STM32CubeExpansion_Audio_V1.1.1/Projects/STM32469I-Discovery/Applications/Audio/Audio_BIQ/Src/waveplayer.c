...
#define TOUCH_BIQ_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_BIQ_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_BIQ_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_BIQ_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_BIQ_EN_XOFFSET    30
#define TOUCH_BIQ_PARAM_LINE    10

#define TOUCH_BIQ_NEXT_XMIN    (int)(412*(800.0/480))
#define TOUCH_BIQ_NEXT_XMAX    (int)(452*(800.0/480))
#define TOUCH_BIQ_NEXT_YMIN    (int)(130*(480.0/272))
#define TOUCH_BIQ_NEXT_YMAX    (int)(170*(480.0/272))

#define TOUCH_BIQ_PREVIOUS_XMIN (int)(342*(800.0/480))
#define TOUCH_BIQ_PREVIOUS_XMAX (int)(382*(800.0/480))
#define TOUCH_BIQ_PREVIOUS_YMIN (int)(130*(480.0/272))
#define TOUCH_BIQ_PREVIOUS_YMAX (int)(170*(480.0/272))
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_BIQ_EN_XMIN+TOUCH_BIQ_EN_XOFFSET, LINE(5), (uint8_t *)"BIQ ON/OFF", LEFT_MODE);
  /* minus setting icon */
...
static int32_t AUDIO_PLAYER_Dynamic_Cfg(void)
{
  ...
  switch(AudioCfgChange)
  {
    ...
    case AUDIO_CFG_BIQ_DIS:
      ...
      BSP_LCD_DisplayStringAt(TOUCH_BIQ_EN_XMIN, LINE(MSG_MOD_LINE), (uint8_t *)"BIQ Filter: OFF", LEFT_MODE);   /* LCD RK043FN48H: 480*272 pixels */
