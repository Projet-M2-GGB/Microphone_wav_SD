...
#define TOUCH_CDC_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_CDC_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_CDC_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_CDC_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_CDC_EN_XOFFSET    50
#define TOUCH_CDC_PARAM_LINE    10

#define TOUCH_CDC_NEXT_MODE_XMIN    (int)(412*(800.0/480))
#define TOUCH_CDC_NEXT_MODE_XMAX    (int)(452*(800.0/480))
#define TOUCH_CDC_NEXT_MODE_YMIN    (int)(130*(480.0/272))
#define TOUCH_CDC_NEXT_MODE_YMAX    (int)(170*(480.0/272))

#define TOUCH_CDC_PREVIOUS_MODE_XMIN    (int)(342*(800.0/480))
#define TOUCH_CDC_PREVIOUS_MODE_XMAX    (int)(382*(800.0/480))
#define TOUCH_CDC_PREVIOUS_MODE_YMIN    (int)(130*(480.0/272))
#define TOUCH_CDC_PREVIOUS_MODE_YMAX    (int)(170*(480.0/272))
...
void *pCdcPersistentMem1 = NULL;
void *pCdcScratchMem1 = NULL;
...
AUDIO_ErrorTypeDef AUDIO_PLAYER_Init(void)
{
  ...
  pCdcPersistentMem1 = malloc(cdc_persistent_mem_size); /* cdc_persistent_mem_size  0x0C */
  pCdcScratchMem1 = malloc(cdc_scratch_mem_size);       /* cdc_scratch_mem_size  0x01F8 */
...
AUDIO_ErrorTypeDef AUDIO_PLAYER_Start(uint8_t idx)
{
  ...
  { 
    ...
    error = cdc_reset(pCdcPersistentMem1, pCdcScratchMem1);
    if (error != CDC_ERROR_NONE)
    {
      return (AUDIO_ERROR_CDC);
    }
    ...
    error = cdc_setConfig(&cdc_dynamic_param, pCdcPersistentMem1);
    if (error != CDC_ERROR_NONE)
    {
        return (AUDIO_ERROR_CDC);
    }
...
AUDIO_ErrorTypeDef AUDIO_PLAYER_Process(void)
{
  ...
  case AUDIO_STATE_PLAY:
    ...
    if(BufferCtl.state == BUFFER_OFFSET_HALF)
    {
      ...
      error = cdc_process(pInputBuffer, pOutputBuffer, pCdcPersistentMem1);
      if (error != CDC_ERROR_NONE)
      {
        return (AUDIO_ERROR_CDC);
      }   
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_CDC_EN_XMIN+TOUCH_CDC_EN_XOFFSET, LINE(5), (uint8_t *)"CDC ON", LEFT_MODE);
...
static void AUDIO_DisplayCdcSettings(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_CDC_PREVIOUS_MODE_XMIN-CHAR(7), LINE(MSG_MOD_LINE), (uint8_t *)str, LEFT_MODE);
