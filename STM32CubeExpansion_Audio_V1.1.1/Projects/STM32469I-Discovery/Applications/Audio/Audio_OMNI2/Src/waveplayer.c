...
#define TOUCH_OMNI2_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_OMNI2_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_OMNI2_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_OMNI2_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_OMNI2_EN_XOFFSET    20
#define TOUCH_OMNI2_PARAM_LINE    10

#define TOUCH_OMNI2_NEXT_XMIN    (int)(412*(800.0/480))
#define TOUCH_OMNI2_NEXT_XMAX    (int)(452*(800.0/480))
#define TOUCH_OMNI2_NEXT_YMIN    (int)(130*(480.0/272))
#define TOUCH_OMNI2_NEXT_YMAX    (int)(170*(480.0/272))

#define TOUCH_OMNI2_PREVIOUS_XMIN    (int)(342*(800.0/480))
#define TOUCH_OMNI2_PREVIOUS_XMAX    (int)(382*(800.0/480))
#define TOUCH_OMNI2_PREVIOUS_YMIN    (int)(130*(480.0/272))
#define TOUCH_OMNI2_PREVIOUS_YMAX    (int)(170*(480.0/272))
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_OMNI2_EN_XMIN+TOUCH_OMNI2_EN_XOFFSET, LINE(5), (uint8_t *)"OMNI2 ON/OFF", LEFT_MODE);
...
static int32_t AUDIO_PLAYER_Dynamic_Cfg(void)
{
  ...
  switch(AudioCfgChange)
  {
    ...
    case AUDIO_CFG_OMNI2_DIS:
      ...
      BSP_LCD_DisplayStringAt(TOUCH_OMNI2_EN_XMIN, LINE(TOUCH_OMNI2_PARAM_LINE), (uint8_t *)"                    ", LEFT_MODE);
      AudioCfgChange = AUDIO_CFG_NONE;
      break;
...
{ 
  ...
  BSP_LCD_DisplayStringAt(TOUCH_OMNI2_EN_XMIN, LINE(TOUCH_OMNI2_PARAM_LINE), (uint8_t *)"[No center, AMODE20]", LEFT_MODE); /* No center output, stereo channels input 2.0 */
}
...
static void AUDIO_DisplayOmni2Presettings(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_OMNI2_PREVIOUS_XMIN-CHAR(21), LINE(MSG_MOD_LINE), (uint8_t *)str, LEFT_MODE);
