...
#define OMNI2_STRENGTH_MAX  100
#define OMNI2_STRENGTH_MIN  0
#define OMNI2_STRENGTH_DEFAULT  80

#define OMNI2_AUDIOMODEIDX_MAX  6
#define OMNI2_AUDIOMODEIDX_MIN  0

#define OMNI2Audio_LSIDX_MAX  2
#define OMNI2Audio_LSIDX_MIN  0
...
typedef enum {
  ...
  AUDIO_CFG_OMNI2_EN,
  AUDIO_CFG_OMNI2_DIS,
  AUDIO_CFG_OMNI2_STRENGTH_PREVIOUS,
  AUDIO_CFG_OMNI2_STRENGTH_NEXT,
  AUDIO_CFG_OMNI2_LSANG_PREVIOUS,
  AUDIO_CFG_OMNI2_LSANG_NEXT,
  AUDIO_CFG_ERROR,  
