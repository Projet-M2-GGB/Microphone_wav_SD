...
#define TOUCH_SMR_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_SMR_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_SMR_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_SMR_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_SMR_EN_XOFFSET    30
#define TOUCH_SMR_PARAM_LINE    10

#define TOUCH_SMR_NEXT_AVGTIME_XMIN    (int)(412*(800.0/480))
#define TOUCH_SMR_NEXT_AVGTIME_XMAX    (int)(452*(800.0/480))
#define TOUCH_SMR_NEXT_AVGTIME_YMIN    (int)(130*(480.0/272))
#define TOUCH_SMR_NEXT_AVGTIME_YMAX    (int)(170*(480.0/272))

#define TOUCH_SMR_PREVIOUS_AVGTIME_XMIN    (int)(342*(800.0/480))
#define TOUCH_SMR_PREVIOUS_AVGTIME_XMAX    (int)(382*(800.0/480))
#define TOUCH_SMR_PREVIOUS_AVGTIME_YMIN    (int)(130*(480.0/272))
#define TOUCH_SMR_PREVIOUS_AVGTIME_YMAX    (int)(170*(480.0/272))
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_SMR_EN_XMIN+TOUCH_SMR_EN_XOFFSET, LINE(5), (uint8_t *)"SMR ON/OFF", LEFT_MODE);
...
static int32_t AUDIO_PLAYER_Dynamic_Cfg(void)
{
  ...
  switch(AudioCfgChange)
  {
    ...
    case AUDIO_CFG_SMR_DIS:
      ...
      BSP_LCD_DisplayStringAt(TOUCH_SMR_EN_XMIN, LINE(TOUCH_SMR_PARAM_LINE), (uint8_t *)"                    ", LEFT_MODE);
      AudioCfgChange = AUDIO_CFG_NONE;
      break;
...
static void AUDIO_DisplaySmrStaticSettings(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_SMR_EN_XMIN+CHAR(2), LINE(TOUCH_SMR_PARAM_LINE), (uint8_t *)"[A-Weighting]", LEFT_MODE);
}
