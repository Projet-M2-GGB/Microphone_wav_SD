...
this example will exit displaying an error message. It is recommended on 
STM32469I-Discovery board to limit updated information on LCD display to reduce parasitic
noise during dynamic reconfiguration of some module parameters. 
...
@par Directory contents 
  ...
  - Audio_SMR/Src/stm32f4xx_it.c       Interrupt handlers
  - Audio_SMR/Src/system_stm32f4xx.c   STM32F4xx system source file
  ...
  - Audio_SMR/Inc/stm32f4xx_hal_conf.h HAL configuration file
  - Audio_SMR/Inc/stm32f4xx_it.h       Interrupt handlers header file
