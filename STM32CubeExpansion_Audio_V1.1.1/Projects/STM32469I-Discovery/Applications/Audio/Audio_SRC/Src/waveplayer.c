...
#define TOUCH_SRC_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_SRC_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_SRC_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_SRC_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_SRC_EN_XOFFSET    30
#define TOUCH_SRC_PARAM_LINE    10
...
static void AUDIO_PLAYER_DisplaySettings(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_NEXT_XMIN-CHAR(10), LINE(MSG_MOD_LINE), (uint8_t *)str, LEFT_MODE);
