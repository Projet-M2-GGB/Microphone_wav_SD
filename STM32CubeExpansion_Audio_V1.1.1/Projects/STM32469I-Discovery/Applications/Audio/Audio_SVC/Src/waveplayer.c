...
#define TOUCH_SVC_EN_XMIN       (int)(278*(800.0/480))
#define TOUCH_SVC_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_SVC_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_SVC_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_SVC_EN_XOFFSET    10

#define PLAYER_COUNT_TEXT_XMIN  (int)(263*(800.0/480))
...
{ 
  ...
  BSP_LCD_DisplayStringAt(TOUCH_SVC_EN_XMIN+TOUCH_SVC_EN_XOFFSET, LINE(5), (uint8_t *)"SVC MUTE ON/OFF", LEFT_MODE);
...
{ 
  ...
  {     
    ...
    case AUDIO_CFG_SVC_MUTE_EN:
      ...
      BSP_LCD_DisplayStringAt(TOUCH_SVC_EN_XMIN-CHAR(15), LINE(MSG_MOD_LINE), (uint8_t *)"Smart Volume Control (SVC): MUTE", LEFT_MODE); 
      AudioCfgChange = AUDIO_CFG_NONE;
      break;
