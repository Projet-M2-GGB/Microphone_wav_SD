...
#define TOUCH_SDR_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_SDR_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_SDR_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_SDR_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_SDR_EN_XOFFSET    30
#define TOUCH_SDR_PARAM_LINE    10

#define TOUCH_SDR_NEXT_XMIN    (int)(412*(800.0/480))
#define TOUCH_SDR_NEXT_XMAX    (int)(452*(800.0/480))
#define TOUCH_SDR_NEXT_YMIN    (int)(130*(480.0/272))
#define TOUCH_SDR_NEXT_YMAX    (int)(170*(480.0/272))

#define TOUCH_SDR_PREVIOUS_XMIN    (int)(342*(800.0/480))
#define TOUCH_SDR_PREVIOUS_XMAX    (int)(382*(800.0/480))
#define TOUCH_SDR_PREVIOUS_YMIN    (int)(130*(480.0/272))
#define TOUCH_SDR_PREVIOUS_YMAX    (int)(170*(480.0/272))
  ...
  case AUDIO_STATE_PLAY:
    ...
    if(BufferCtl.state == BUFFER_OFFSET_HALF)
    {
      ...
      {	  
        ...
        BSP_LCD_DisplayStringAt(CHAR(0), LINE(11), (uint8_t *)str_dec, LEFT_MODE); 
      }
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_SDR_EN_XMIN+TOUCH_SDR_EN_XOFFSET, LINE(5), (uint8_t *)"SDR ON/OFF", LEFT_MODE);
...
static int32_t AUDIO_PLAYER_Dynamic_Cfg(void)
{
  ...
  switch(AudioCfgChange)
  {
    ...
    case AUDIO_CFG_SDR_DIS:
      ...
      BSP_LCD_DisplayStringAt(TOUCH_SDR_EN_XMIN, LINE(TOUCH_SDR_PARAM_LINE), (uint8_t *)"                    ", LEFT_MODE);
      AudioCfgChange = AUDIO_CFG_NONE;
      break;
...
static void AUDIO_DisplaySdrStaticPresettings(void)
{
  BSP_LCD_SetTextColor(LCD_COLOR_GREEN);
  BSP_LCD_SetFont(&LCD_LOG_TEXT_FONT);
  BSP_LCD_DisplayStringAt(TOUCH_SDR_EN_XMIN, LINE(TOUCH_SDR_PARAM_LINE), (uint8_t *)"[4 Frames, -60 dBFS]", LEFT_MODE); /* No center output, stereo channels input 2.0 */
...
static void AUDIO_DisplaySdrPresettings(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_SDR_PREVIOUS_XMIN-CHAR(3), LINE(MSG_MOD_LINE), (uint8_t *)str, LEFT_MODE);
}
