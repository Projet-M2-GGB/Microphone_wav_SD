...
#define AUDIO_CFG_BAM_VOL_MAX                      24
#define AUDIO_CFG_BAM_VOL_MIN                     -24
#define AUDIO_CFG_BAM_VOL_DEFAULT                  0

#define AUDIO_CFG_BAM_FREQX_MAX                    11 /* 300Hz */
#define AUDIO_CFG_BAM_FREQX_MIN                    0  /* 60Hz  */
#define AUDIO_CFG_BAM_FREQX_DEFAULT                4  /* 120Hz */
...
typedef enum {
  ...
  AUDIO_CFG_BAM_EN,
  AUDIO_CFG_BAM_DIS,
  AUDIO_CFG_BAM_VOL_PREVIOUS,
  AUDIO_CFG_BAM_VOL_NEXT,
  AUDIO_CFG_BAM_FREQX_PREVIOUS,
  AUDIO_CFG_BAM_FREQX_NEXT,
  AUDIO_CFG_ERROR,  
