...
#define TOUCH_BAM_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_BAM_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_BAM_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_BAM_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_BAM_EN_XOFFSET    30
#define TOUCH_BAM_PARAM_LINE    10

#define TOUCH_BAM_NEXT_VOL_XMIN    (int)(412*(800.0/480))
#define TOUCH_BAM_NEXT_VOL_XMAX    (int)(452*(800.0/480))
#define TOUCH_BAM_NEXT_VOL_YMIN    (int)(130*(480.0/272))
#define TOUCH_BAM_NEXT_VOL_YMAX    (int)(170*(480.0/272))

#define TOUCH_BAM_PREVIOUS_VOL_XMIN    (int)(342*(800.0/480))
#define TOUCH_BAM_PREVIOUS_VOL_XMAX    (int)(382*(800.0/480))
#define TOUCH_BAM_PREVIOUS_VOL_YMIN    (int)(130*(480.0/272))
#define TOUCH_BAM_PREVIOUS_VOL_YMAX    (int)(170*(480.0/272))

#define PLAYER_COUNT_TEXT_XMIN  (int)(243*(800.0/480))
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_BAM_EN_XMIN+TOUCH_BAM_EN_XOFFSET, LINE(5), (uint8_t *)"BAM ON/OFF", LEFT_MODE);
