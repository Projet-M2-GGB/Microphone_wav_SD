...
#define TOUCH_GREQ_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_GREQ_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_GREQ_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_GREQ_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_GREQ_EN_XOFFSET    30
#define TOUCH_GREQ_PARAM_LINE    10

#define TOUCH_GREQ_NEXT_XMIN    (int)(412*(800.0/480))
#define TOUCH_GREQ_NEXT_XMAX    (int)(452*(800.0/480))
#define TOUCH_GREQ_NEXT_YMIN    (int)(130*(480.0/272))
#define TOUCH_GREQ_NEXT_YMAX    (int)(170*(480.0/272))

#define TOUCH_GREQ_PREVIOUS_XMIN    (int)(342*(800.0/480))
#define TOUCH_GREQ_PREVIOUS_XMAX    (int)(382*(800.0/480))
#define TOUCH_GREQ_PREVIOUS_YMIN    (int)(130*(480.0/272))
#define TOUCH_GREQ_PREVIOUS_YMAX    (int)(170*(480.0/272))
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DrawRect(TOUCH_GREQ_EN_XMIN, TOUCH_GREQ_EN_YMIN , /* GREQ rectangle */
                   TOUCH_GREQ_EN_XMAX - TOUCH_GREQ_EN_XMIN,
                   TOUCH_GREQ_EN_YMAX - TOUCH_GREQ_EN_YMIN);
  BSP_LCD_DisplayStringAt(TOUCH_GREQ_EN_XMIN+TOUCH_GREQ_EN_XOFFSET, LINE(5), (uint8_t *)"GrEq ON/OFF", LEFT_MODE);

  /* GREQ minus setting icon */
...
static int32_t AUDIO_PLAYER_Dynamic_Cfg(void)
{
  ...
  switch(AudioCfgChange)
  {
    ...
    case AUDIO_CFG_GREQ_DIS:
      ...
      BSP_LCD_DisplayStringAt(TOUCH_GREQ_EN_XMIN, LINE(TOUCH_GREQ_PARAM_LINE), (uint8_t *)"                    ", RIGHT_MODE);
      AudioCfgChange = AUDIO_CFG_NONE;
      break;
...
static void AUDIO_DisplayEqStaticPresettings(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_GREQ_EN_XMIN+CHAR(2), LINE(TOUCH_GREQ_PARAM_LINE), (uint8_t *)"[ 10 bands ]", LEFT_MODE);
}
