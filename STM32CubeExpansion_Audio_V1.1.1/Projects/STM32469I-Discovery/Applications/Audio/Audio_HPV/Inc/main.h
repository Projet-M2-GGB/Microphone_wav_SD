...
#define HPV_STRENGTH_MAX  100
#define HPV_STRENGTH_MIN  0
#define HPV_STRENGTH_INIT 80

#define HPV_AUDIOMODEIDX_MAX  4
#define HPV_AUDIOMODEIDX_MIN  0
...
typedef enum {
  ...
  AUDIO_CFG_HPV_EN,
  AUDIO_CFG_HPV_DIS,
  AUDIO_CFG_HPV_STRENGTH_PREVIOUS,
  AUDIO_CFG_HPV_STRENGTH_NEXT,
  AUDIO_CFG_ERROR,  
