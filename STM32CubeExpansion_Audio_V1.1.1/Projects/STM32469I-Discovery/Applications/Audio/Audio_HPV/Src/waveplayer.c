...
/* LCD OTM8009A on F4 Disco: 800*480 pixels */

#define TOUCH_NEXT_XMIN         (int)(325*(800.0/480))
#define TOUCH_NEXT_XMAX         (int)(365*(800.0/480))
#define TOUCH_NEXT_YMIN         (int)(212*(480.0/272))
#define TOUCH_NEXT_YMAX         (int)(252*(480.0/272))

#define TOUCH_PREVIOUS_XMIN     (int)(250*(800.0/480))
#define TOUCH_PREVIOUS_XMAX     (int)(290*(800.0/480))
#define TOUCH_PREVIOUS_YMIN     (int)(212*(480.0/272))
#define TOUCH_PREVIOUS_YMAX     (int)(252*(480.0/272))

#define TOUCH_STOP_XMIN         (int)(170*(800.0/480))
#define TOUCH_STOP_XMAX         (int)(210*(800.0/480))
#define TOUCH_STOP_YMIN         (int)(212*(480.0/272))
#define TOUCH_STOP_YMAX         (int)(252*(480.0/272))

#define TOUCH_PAUSE_XMIN        (int)(100*(800.0/480))
#define TOUCH_PAUSE_XMAX        (int)(135*(800.0/480))
#define TOUCH_PAUSE_YMIN        (int)(212*(480.0/272))
#define TOUCH_PAUSE_YMAX        (int)(252*(480.0/272))
#define TOUCH_PAUSE_XSPACE       30               
...
#define TOUCH_VOL_MINUS_XOFFSET (int)(4*(480.0/272))
#define TOUCH_VOL_LINE          17
...
#define TOUCH_HPV_EN_XMIN       (int)(310*(800.0/480))
#define TOUCH_HPV_EN_XMAX       (int)(454*(800.0/480))
#define TOUCH_HPV_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_HPV_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_HPV_EN_XOFFSET    30
#define TOUCH_HPV_PARAM_LINE    8

#define TOUCH_HPV_NEXT_XMIN    (int)(412*(800.0/480)-20)
#define TOUCH_HPV_NEXT_XMAX    (int)(452*(800.0/480)-20)
#define TOUCH_HPV_NEXT_YMIN    (int)(130*(480.0/272))
#define TOUCH_HPV_NEXT_YMAX    (int)(170*(480.0/272))

#define TOUCH_HPV_PREVIOUS_XMIN    (int)(342*(800.0/480)-20)
#define TOUCH_HPV_PREVIOUS_XMAX    (int)(382*(800.0/480)-20)
#define TOUCH_HPV_PREVIOUS_YMIN    (int)(130*(480.0/272))
#define TOUCH_HPV_PREVIOUS_YMAX    (int)(170*(480.0/272))

#define PLAYER_COUNT_TEXT_XMIN  (int)(240*(800.0/480))
#define PLAYER_COUNT_TEXT_LINE   8
#define MSG_MOD_LINE             16 
...
AUDIO_ErrorTypeDef AUDIO_PLAYER_Start(uint8_t idx)
{
  ...
  { 
    ...
    if  (WaveFormat.NbrChannels != 2) 
    {
      ...
      BSP_LCD_SetTextColor(LCD_COLOR_RED);
      BSP_LCD_DisplayStringAtLine(MSG_MOD_LINE,  (uint8_t*) "Error: only stereo audio input is supported.");
      BSP_LCD_SetTextColor(LCD_COLOR_BLACK);
      f_close(&WavFile);
      AudioState = AUDIO_STATE_STOP;
      return (AUDIO_ERROR_INVALID_VALUE);
...
AUDIO_ErrorTypeDef AUDIO_PLAYER_Process(void)
{
  ...
  case AUDIO_STATE_RESUME:
    BSP_LCD_SetTextColor(LCD_COLOR_CYAN);    /* Display blue cyan pause rectangles */
    BSP_LCD_DisplayStringAt(PLAYER_COUNT_TEXT_XMIN, LINE(PLAYER_COUNT_TEXT_LINE+1), (uint8_t *)"[PLAY ]", LEFT_MODE);
    BSP_LCD_FillRect(TOUCH_PAUSE_XMIN, TOUCH_PAUSE_YMIN , 15, TOUCH_PAUSE_YMAX - TOUCH_PAUSE_YMIN);
    BSP_LCD_FillRect(TOUCH_PAUSE_XMIN + TOUCH_PAUSE_XSPACE, TOUCH_PAUSE_YMIN, 15, TOUCH_PAUSE_YMAX - TOUCH_PAUSE_YMIN);
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_HPV_EN_XMIN+TOUCH_HPV_EN_XOFFSET, LINE(5), (uint8_t *)"HPV ON/OFF", LEFT_MODE);
...
static int32_t AUDIO_PLAYER_Dynamic_Cfg(void)
{
  ...
  switch(AudioCfgChange)
  {
    ...
    case AUDIO_CFG_HPV_DIS:
      ...
      BSP_LCD_DisplayStringAt(TOUCH_HPV_PREVIOUS_XMIN, LINE(MSG_MOD_LINE), (uint8_t *)"HPV OFF", LEFT_MODE);   /* LCD RK043FN48H: 480*272 pixels */
      BSP_LCD_DisplayStringAt(TOUCH_HPV_EN_XMIN, LINE(TOUCH_HPV_PARAM_LINE), (uint8_t *)"                    ", LEFT_MODE);
      BSP_LCD_DisplayStringAt(TOUCH_HPV_EN_XMIN, LINE(TOUCH_HPV_PARAM_LINE+1), (uint8_t *)"                    ", LEFT_MODE);     
      AudioCfgChange = AUDIO_CFG_NONE;
      break;
...
static void AUDIO_DisplayHpvPresettings(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_HPV_EN_XMIN, LINE(TOUCH_HPV_PARAM_LINE), (uint8_t *)"[LFE OFF, HD OFF]", LEFT_MODE); 
  ...
  BSP_LCD_DisplayStringAt(TOUCH_HPV_EN_XMIN, LINE(TOUCH_HPV_PARAM_LINE+1),(uint8_t *)str, LEFT_MODE);
