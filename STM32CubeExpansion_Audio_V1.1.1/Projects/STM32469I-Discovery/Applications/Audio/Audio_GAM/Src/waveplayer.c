...
#define TOUCH_GAM_EN_XMIN       (int)(300*(800.0/480))
#define TOUCH_GAM_EN_XMAX       (int)(464*(800.0/480))
#define TOUCH_GAM_EN_YMIN       (int)(55*(480.0/272))
#define TOUCH_GAM_EN_YMAX       (int)(85*(480.0/272))
#define TOUCH_GAM_EN_XOFFSET    10
#define TOUCH_GAM_PARAM_LINE    10

#define TOUCH_GAM_NEXT_VOL_XMIN    (int)(412*(800.0/480))
#define TOUCH_GAM_NEXT_VOL_XMAX    (int)(452*(800.0/480))
#define TOUCH_GAM_NEXT_VOL_YMIN    (int)(130*(480.0/272))
#define TOUCH_GAM_NEXT_VOL_YMAX    (int)(170*(480.0/272))

#define TOUCH_GAM_PREVIOUS_VOL_XMIN    (int)(342*(800.0/480))
#define TOUCH_GAM_PREVIOUS_VOL_XMAX    (int)(382*(800.0/480))
#define TOUCH_GAM_PREVIOUS_VOL_YMIN    (int)(130*(480.0/272))
#define TOUCH_GAM_PREVIOUS_VOL_YMAX    (int)(170*(480.0/272))

#define PLAYER_COUNT_TEXT_XMIN  (int)(240*(800.0/480))
#define PLAYER_COUNT_TEXT_LINE   8
#define MSG_MOD_LINE             16 

#define XOFFSET_DISP             230
...
static int16_t TargVoldB[GAM_NB_CHAN_MAX]= {AUDIO_CFG_GAM_VOL_DEFAULT,AUDIO_CFG_GAM_VOL_DEFAULT,AUDIO_CFG_GAM_VOL_DEFAULT,AUDIO_CFG_GAM_VOL_DEFAULT,
                                            AUDIO_CFG_GAM_VOL_DEFAULT,AUDIO_CFG_GAM_VOL_DEFAULT,AUDIO_CFG_GAM_VOL_DEFAULT,AUDIO_CFG_GAM_VOL_DEFAULT}; //{0,0,0,0,0,0,0,0};   //{-12,-12,-12,-12,-12,-12,-12,-12};
...
static void AUDIO_PlaybackDisplayButtons(void)
{
  ...
  BSP_LCD_DisplayStringAt(TOUCH_GAM_EN_XMIN+TOUCH_GAM_EN_XOFFSET, LINE(5), (uint8_t *)"GAM MUTE ON/OFF", LEFT_MODE);
...
static int32_t AUDIO_PLAYER_Dynamic_Cfg(void)
{
  ...
  switch(AudioCfgChange)
  {
    ...
    case AUDIO_CFG_GAM_MUTE_EN: /*Enable Mute on ALL channels*/
      ...
      BSP_LCD_DisplayStringAt(TOUCH_GAM_PREVIOUS_VOL_XMIN, LINE(MSG_MOD_LINE), (uint8_t *)"GAM OFF", LEFT_MODE);  /* LCD RK043FN48H: 480*272 pixels */

      BSP_LCD_DisplayStringAt(TOUCH_GAM_EN_XMIN, LINE(TOUCH_GAM_PARAM_LINE), (uint8_t *)"                    ", LEFT_MODE);
      AudioCfgChange = AUDIO_CFG_NONE;
      break;
...
static void AUDIO_DisplayGamSettings(void)
{
  ...
  sprintf((char *)str, "GAM Channel: %lu  Volume set: %d.%d dB", chan_idx, abs(TargVoldB[chan_idx]/2), abs(((TargVoldB[chan_idx]*10)/2)-((TargVoldB[chan_idx]/2)*10))); 
   ...
   BSP_LCD_DisplayStringAt(TOUCH_GAM_PREVIOUS_CHAN_XMIN-CHAR(5), LINE(MSG_MOD_LINE), (uint8_t *)str, LEFT_MODE);
