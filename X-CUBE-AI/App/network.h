...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "voice_recon_mini_v2"
...
#define AI_NETWORK_IN_1_HEIGHT      (124)
#define AI_NETWORK_IN_1_WIDTH       (129)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (15996)
#define AI_NETWORK_IN_1_SIZE_BYTES  (63984)
